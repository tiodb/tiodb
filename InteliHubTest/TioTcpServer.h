...
#include "pch.h"
#include "buffer.h" // classe para encapsular um buffer
#include "Command.h" // source, params, command e um buffer
#include "ContainerManager.h"  // gerencia todos os conteiners
